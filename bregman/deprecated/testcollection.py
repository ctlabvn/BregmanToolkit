...
class TestCollection(audiocollection.AudioCollection):
    ...
    def print(_results(self, test_set_list=None):)
        """
        ::
    ...
    def get_test_sets(self):
        ...
        ::
            ...
            Use print(_test_sets() to get a more readable display)
        """
        adb = audiodb.adb.get(self.adb_path,"r")
        km = KeyMapper(adb, self.num_patterns)
            ...
            for p_tuple in sequencer_list:
                ...
                for f_tuple in analyzer_list:
                    for f_key, f_val in f_tuple:
                        ...
                        print(f_key, f_val)
                    print(curr_gt_key, curr_trans_key = self.extract_features() )
                    self.load_results()
    ...
    @staticmethod
    def _print(_dict_list_tuples(dict_list=None, params_dict=None):)
        """
        ::
